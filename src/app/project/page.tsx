...
import AddProjectForm from './../../components/project/AddProjectFrom';
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="flex justify-between items-center mb-8">
                <h2 className="text-xl text-white font-extrabold tracking-widest uppercase">All Projects</h2>
                {!showForm && (
                    <button onClick={() => setShowForm(true)} className="flex items-center bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        <FaPlus className="mr-2" /> Project
                    </button>
                )}
            </div>
            <AnimatePresence>

            {showForm && <AddProjectForm setShowForm={setShowForm}  />}
            </AnimatePresence>
                ...
                <table className="table-auto w-full border-collapse rounded-2xl border border-gray-300">
                    <thead>
                        <tr className="bg-gray-200">
                            ...
                            <th className="border border-gray-300 px-4 py-2">Team Members</th>
                            <th className="border border-gray-300 px-4 py-2">Tech Stack</th>
